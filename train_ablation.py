...
if __name__ == '__main__':
    ...
    #MTL Network without bbox auxiliary task
    net = models.AblatedNet(c_in=3, c_out_seg=1)
    net = net.float()
    ...
    for epoch in range(1):
        ...
        for i, data in enumerate(trainloader, 0):
            ...
            optimizer.zero_grad()
            bin_pred, mask_pred = net(images.float())
            ...
            bin_weight = 0.5
            seg_weight = 0.5 
            total_loss = (bin_loss * bin_weight) + (seg_loss * seg_weight)
